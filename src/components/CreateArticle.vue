                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-sm-4">
                            <div class="side-input">
                                ...
                                <button type="button" class="btn btn-outline-primary" disabled>Preview</button>
                                <button type="button" class="btn btn-outline-primary" disabled>Simpan</button>
...
export default {
        ...
        return {
            ...
            editorConfig: {
                link: {
                    ...
                    defaultProtocol: 'http://localhost:3000'
                },
                ckfinder: {
                    // The URL that the images are uploaded to.
                    uploadUrl: 'http://localhost:3000/artikel/draft/upload/ART0000000005',
    ...
    mounted() {
        ...
        try {
            axios.get("http://localhost:3000/kategori")
                .then((response) => {
                    this.kategoriArtikel = response.data
                })
            axios.get("http://localhost:3000/artikel/draft/ART0000000005")
                .then((response) => {
    ...
    methods: {
        uploadFile() {
            this.dataEditor.cover_artikel = this.$refs.file.files[0];
        },
        onReady(editor) {
        ...
        addDataArticle: function () {
            try {
                ...
                axios.patch("http://localhost:3000/artikel/draft/ART0000000005", this.dataEditor, { headers })
                    .then(response => {
