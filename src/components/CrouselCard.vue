<template >
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="cards-wrapper">
                    ...
                    <div class="card">
                        <div class="image-wrapper">
                            <img src="../assets/makanan.jpg" alt="...">
                    ...
                    <div class="card">
                        <div class="image-wrapper">
                            <img src="../assets/penginapan.jpg" alt="...">
                    ...
                    <div class="card">
                        <div class="image-wrapper">
                            <img src="../assets/restoran.jpg" alt="...">
        ...
        <button class="carousel-control-pre" type="button" data-bs-target="#carouselExampleControls"
            data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-nex" type="button" data-bs-target="#carouselExampleControls"
            data-bs-slide="next">
...
export default {
    ...
    methods: {
        getItem() {
            axios
                .get("http://localhost:3000/artikel/publish/limit/3")
                .then((response) => {
                    this.datas1 = response.data.data;
                    // console.log("res1", this.datas1[0]);
                    // console.log("res2", this.datas1[1]);
                    // console.log("res3", this.datas1[2]);                    
